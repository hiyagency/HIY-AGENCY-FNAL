...
export const adminModules = {
  ...
  case_studies: {
    ...
    fields: [
      ...
      { name: "short_summary", label: "Short summary", type: "textarea" },
      { name: "full_description", label: "Full description", type: "textarea" },
      { name: "services_delivered", label: "Services delivered", type: "tags" },
      { name: "results", label: "Results / metrics", type: "textarea" },
      { name: "cover_image_url", label: "Cover image", type: "image", uploadFolder: "case-covers" },
      { name: "gallery_images", label: "Gallery images", type: "images", uploadFolder: "case-gallery" },
      { name: "website_url", label: "Website / live URL", type: "text" },
      { name: "status", label: "Published status", type: "select", options: ["Draft", "Published"] },
      { name: "featured", label: "Featured", type: "boolean" },
      { name: "display_order", label: "Display order", type: "number" },
    ],
  },
